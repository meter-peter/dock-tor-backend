...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/history/{medicalHistoryID}/latest": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "models.Patient": {
            ...
            "properties": {
                "amka": {
                    "description": "@Description The patient's AMKA (Social Security Number)",
                    "type": "string",
                    "example": "12345678901"
                },
                "created_at": {
                ...
                "registration": {
                    "description": "@Description The date of patient registration",
                    "type": "string",
                    "example": "2023-01-01T00:00:00Z"
                },
                "updated_at": {
